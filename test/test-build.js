...
/***/ function(module, exports, __webpack_require__) {
	...
	_vue2.default.use(_vue2.default.lazyimg);
	var loop1 = new _vue2.default({
	    mixins: [_carousel2.default],
	    el: '#loop1',
	    data: {
	        'list': testData,
	...
	var autoplay = new _vue2.default({
	    mixins: [_carousel2.default],
	    el: '#noloop',
	    data: {
	        'list': testData,
	...
	var slider15 = new _vue2.default({
	    mixins: [_carousel2.default],
	    el: '#slider1-5',
	    data: {
	        'list': testData,
	...
	var noPagination = new _vue2.default({
	    mixins: [_carousel2.default],
	    el: '#no-pagination',
	    data: {
	        'list': testData,
	...
	var scrollerDemo = new _vue2.default({
	    mixins: [_scroller2.default],
	    el: '#scroller',
	    data: {
	        'list': testData,
	        'title': 'scroller',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] carousel.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "_v-79e32422/carousel.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.pagination = exports.scroller = exports.slider = exports.carousel = undefined;
	...
	exports.carousel = _swiper2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _swiperBase = __webpack_require__(9);
	...
	exports.default = {
	    ...
	    methods: {
	        loopList: function loopList() {
	            ...
	            for (var _i = this.originList.length - 1; _i >= this.originList.length - length; _i--) {
	                this.list.unshift(this.originList[_i]);
	            }
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-3eab9366/swiper.base.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        touchStart: function touchStart(e) {
	            if (this.animating) this.transitionEnd();
	        ...
	        touchMove: function touchMove(e) {
	            ...
	            if (this.firstFrame) {
	                if (!this.deltaX || !this.deltaY) e.preventDefault();
	            ...
	            if (this.isCanScroll) {
	                if (this.translateX > 0) this.translateX += this.deltaX / 2;else if (this.translateX < -(this.listWidth - this.wrapperWidth)) this.translateX += this.deltaX / 2;else this.translateX += this.deltaX;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-8790652a/scroller.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-48ca2629/pagination.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] scroller.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-05e539fc/scroller.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"carousel-demo\">\n    <h1 class=\"title\">{{title}}</h1>\n    <scroller v-bind:options=\"options\" :list=\"list\">\n        <slider v-for=\"item in list\" track-by=\"$index\" :options=\"options\" slot=\"slider\">\n            <a :href=\"item.href\">\n                <img v-lazyload=\"item.imgSrc\" :src=\"'http://geekie.online/static/image/vue-swiper-demo/default.jpg'\" >\n            </a>\n        </slider>\n        <pagination v-if=\"!noPagenation\" slot=\"pagination\"></pagination>\n    </scroller>\n</div>\n";
